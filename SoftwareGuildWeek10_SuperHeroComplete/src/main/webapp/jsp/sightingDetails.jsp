<%-- 
    ...
    Created on : Jul 19, 2017, 4:18:29 PM
    Author     : yidingweng
--%>
...
<html>
    ...
    <body>
        <div class="container">
            ...
            <p>
                Location: <c:out value="${sighting.location.getLocationName()}"/>
            </p>
            <p>
                Super Hero: <c:out value="${sighting.superHeros.get(0).getSuperHeroName()}"/>
            </p>
