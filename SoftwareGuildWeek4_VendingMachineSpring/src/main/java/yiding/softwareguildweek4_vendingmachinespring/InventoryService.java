...
public class InventoryService {
    ...
    public InventoryService (InventoryDaoInterface dao,InventoryAuditDao auditDao ) {
        this.dao = dao;
    ...
    public void authenticatePurchase(String snackName, double money) throws NoItemInventoryException,InsufficientFundsException, Exception {
        ...
        try {
            ...
            //auditDao.writeAuditEntry("Snack "+ snackName + " purchased/removed");

            dao.insufficientFunds(money,snackPrice);
